...
public class AboutDefaultMethods {
	...
	public void java8_continuousListSorting() {
		...
		//  take a look the the comparing static method on Comparator. Pass in the method reference for getName.
	...
	public void java8_removeListElement() {
		...
		//  take a look at the removeIf method and pass in a predicate the is only true if the element is "d"
		list.removeIf(element->element.equals("d"));
