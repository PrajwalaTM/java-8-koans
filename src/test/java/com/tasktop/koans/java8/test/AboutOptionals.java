...
public class AboutOptionals {
	...
	public void optionalsGiveYouSemantic() {
		...
		assertThat(!bobHasInteresets).isFalse(); //  no optional present. So false can't be true ;)
	}

	@Test
	public void optionalsAreOptional() {
		Optional<String> optional = Optional.ofNullable(null); //  find out how to create an optional of null
